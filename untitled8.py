...
Original file is located at
    https://colab.research.google.com/drive/13_twMyMNQk30_1AlRw1ZA111-lTSPAcN
"""
...
# Student Dashboard Page
    ...
    if not st.session_state.students:
        ...
        if stats:
            ...
            fig = px.line(student_grades_df, x='date', y='score',
                         title=f'Grade Trend for {student["first_name"]} {student["last_name"]}',
                         markers=True)
            ...
            type_avg = student_grades_df.groupby('assignment_type')['score'].mean().reset_index()
            fig = px.bar(type_avg, x='assignment_type', y='score',
                        title='Average Score by Assignment Type',
                        color='score', color_continuous_scale='RdYlGn')
            fig.update_layout(xaxis_title="Assignment Type", yaxis_title="Average Score (%)")
            st.plotly_chart(fig, use_container_width=True)
        else:
...
# Class Analytics Page
    ...
    if not st.session_state.grades:
        ...
        if student_averages:
            ...
            fig = px.histogram(grades_df, x='score', nbins=20,
                             title='Distribution of All Grades',
            ...
            letter_counts = grades_df['letter_grade'].value_counts().reset_index()
            letter_counts.columns = ['Letter Grade', 'Count']
            fig = px.pie(letter_counts, values='Count', names='Letter Grade',
